...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=inter:400,500,600|nunito:400,600,700&display=swap" rel="stylesheet" />
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-[#FAFAF5] rounded-xl shadow-sm border border-[#E0E0E0] overflow-hidden">
        ...
        <div class="p-6 border-b border-[#E0E0E0]">
            <h1 class="text-3xl font-bold text-[#1B5E20]">Nueva Venta</h1>
        </div>

        <form action="{{ route('ventas.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
                ...
                <div id="filas-productos" class="space-y-2">
                    ...
                    <div class="fila-producto grid grid-cols-12 gap-2 items-center">
                        <div class="col-span-5">
                            <select name="productos[0][idproducto]" onchange="cargarPrecio(this)"
                        ...
                        <div class="col-span-2">
                            <input type="number" name="productos[0][cantidad]" placeholder="Cant." min="1" value="1"
                        ...
                        <div class="col-span-3">
                            <input type="number" name="productos[0][preciounitario]" placeholder="Precio" min="1"
                                onchange="recalcularFila(this)"
                                class="w-full border border-[#E0E0E0] rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1B5E20]">
                        </div>
